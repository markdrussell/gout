...
def first_code_in_period(dx_codelist):
    return patients.with_these_clinical_events(
        ...
        return_expectations={
            "incidence": 0.70,
            "date": {"earliest": "1920-01-01", "latest": "index_date"},
        },
    )
...
study = StudyDefinition(
    ...
    default_expectations={
        "date": {"earliest": "1900-01-01", "latest": "index_date + 1 year"},
        "rate": "uniform",
        "incidence": 0.5,
    },
    ...
    first_ult_date=patients.with_these_medications(
        ...
        return_expectations={
            "incidence": 0.90,
            "date": {"earliest": "1920-01-01", "latest": "index_date + 18 months"},
        },
    ),
    ...
    recent_ult_date=patients.with_these_medications(
        ...
        return_expectations={
            "incidence": 0.90,
            "date": {"earliest": "index_date", "latest": "index_date + 18 months"},
        },
    ),
    ...
    **with_these_bloods_date_X(
        ...
        n=7,
        return_expectations={
            "date": {"earliest": "index_date - 6 months", "latest": "index_date + 18 months"},
